  ...
  return (
    <>
      {!isMobuleMenuOpen ? (
        ...
        <div className="fixed right-0 top-0 z-50 flex h-screen w-screen flex-col justify-center gap-16 bg-black/80 text-white hover:text-white/10 ps-10 transition-all">
          <IoMdClose
